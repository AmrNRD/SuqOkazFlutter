...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Map<String, String> _authData = {'phone': '', 'password': '', 'password_confermation': ''};
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(AppLocalizations.of(context).translate("sign_up")+"!", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 25, fontWeight: FontWeight.bold)),
              ...
              Center(child: CustomRaisedButton(label: AppLocalizations.of(context).translate("sign_up"), onPress: onSignUp, isLoading: isLoading, customWidth: 212)),
