...
class _MyOrdersPageState extends State<MyOrdersPage> {
  ...
  @override
  void initState() {
    ordersBloc = OrdersBloc(OrdersDataRepository());
    ordersBloc.add(GetOrdersEvent(isLoadMoreMode: false, userID: Root.user.id));
    super.initState();
  }
                ...
                return Column(
                  children: <Widget>[
                    InkWell(
                      ...
                      onTap: () {
                        Navigator.pushNamed(context, Constants.orderDetailsPage, arguments: ordersList[index]);
                      },
                      child: OrderCard(
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Divider(height: 1,color: AppColors.customGreyLevels[100],)
      ],
    );
  }
}
