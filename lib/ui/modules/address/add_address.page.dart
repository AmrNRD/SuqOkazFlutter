...
class AddAddressPage extends StatefulWidget {
  @override
  _AdAddressPageState createState() => _AdAddressPageState();
}

class _AdAddressPageState extends State<AddAddressPage> {
    ...
    return BlocProvider(
      ...
      child: BlocListener<AddressBloc,AddressState>(
        listener: (context,state){
          ...
          }else if(state is AddressCreatedState){
            setState(() {
              isLoading=false;
            });
...
//                    ),
  ...
  onSave() {
    ...
    addressBloc.add(AddAddressEvent(new AddressModel(address1: _addressData['address1'], address2: _addressData['address2'], company: _addressData['company'], city: _addressData['city'], postCode: _addressData['post_code'], country: _addressData['country'])));
