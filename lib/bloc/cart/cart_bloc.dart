...
//      yield CartButtonUpdateState(totalCartQuantity);
...
//          CartData(
//            userEmail: Root.user.userEmail,
//          ),
//        );
//        cartData = await _cartDataRepository.getCart(Root.user.userEmail);
//      }
